...
\end{equation}
Hausdorff distance ($\mathrm{d_H}$), measures for similarity between two curves, is defined by equation \ref{eq-hausdorff}, where $a \in \textbf{A}$ and $b \in \textbf{B}$.
\begin{equation}
\mathrm{d_H} = \max \{ \min ( \{ \| a-b \| \} ) \}\label{eq-hausdorff}
\end{equation}

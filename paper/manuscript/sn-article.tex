...
\end{tabular}%
\end{center}
\footnotetext{Note: Model code A, B, C refer to experiment setup Section \ref{sec-exp}}
\end{minipage}
\end{table*}

\begin{table*}[]
\centering
\caption{Detection results on the proposed model and baseline models at various settings. All metrics are averaged on box's detected samples at 0.75 IoU}
...
A 	& Dice, Focal, Tversky 	& 0.62 & 9.14 	& 7.79 & 0.5831 \\ \midrule

...
\item Source code is made avaiable at \url{https://github.com/rwttr/NearcamTaplineDetector}, all implementation is done in Julia \cite{Bezanson_Julia_A_fresh_2017} with Flux.jl machine learning library \cite{innes2018}.
\end{itemize}

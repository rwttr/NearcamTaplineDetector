...
The downsampling backbone network borrows Darknet-53 but we trim out the numbers of filters with also shrinking the overall depth, as shown in table \ref{}. Box detection heads conform YOLO boxes' coordinates regression with the objectness scores. This one-stage configuration satisfies the end-to-end training.

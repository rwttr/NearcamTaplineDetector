...
The purpose of the near-range vision camera is for precisely locate the tapping position for robot arm manipulation. Our previous work \cite{bib1} demonstrate an image processing algorithm. The method produces high precision results but it was specially designed that requires two input images accommodating by artificial lighting patterns for the nighttime farming.
